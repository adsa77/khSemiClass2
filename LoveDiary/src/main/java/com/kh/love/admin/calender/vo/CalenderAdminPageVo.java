...
public class CalenderAdminPageVo {
	@Override
	...
	public CalenderAdminPageVo(int listCount, int currentPage, int pageLimit, int boardLimit) {
		...
		this.maxPage = (int)Math.ceil((double)listCount / boardLimit); // double로 소수점까지 구한 뒤 Math.ceil로 올림처리한다. 
