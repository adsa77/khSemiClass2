...
CREATE TABLE TODO (
    ...
    , CATEGORY      VARCHAR2(100)   DEFAULT 'TODO'
    , ENROLL_DATE   TIMESTAMP       DEFAULT SYSDATE
    , MODIFY_DATE   TIMESTAMP   
...
CREATE TABLE DIARY (
    ...
    , CATEGORY      VARCHAR2(100)   DEFAULT 'DIARY'
    , IMG           VARCHAR2(1000)  NULL
    , ENROLL_DATE   TIMESTAMP       DEFAULT SYSDATE
    , MODIFY_DATE   TIMESTAMP       
    , DEL_YN        CHAR(1)         DEFAULT 'N'
...
CREATE TABLE ACCOUNT_BOOK (
    ...
    , CATEGORY      VARCHAR2(100)   DEFAULT 'ACCOUNT_BOOK'
...
CREATE TABLE ANNIVERSARY (
    ...
    , TITLE       VARCHAR2(100)   NOT NULL
    , CONTENT     VARCHAR2(4000)  NOT NULL
    , CATEGORY    VARCHAR2(100)   DEFAULT 'ANNIVERSARY'
    , ENROLL_DATE TIMESTAMP       DEFAULT     SYSDATE
    , MODIFY_DATE TIMESTAMP      
    , DEL_YN      CHAR(1)         DEFAULT'N'
    , CHECK_DATE  DATE
...
CREATE TABLE HOLIDAY (
    ...
    , HOLIDAY_DATE  DATE
    , CATEGORY      VARCHAR2(100)   DEFAULT 'HOLIDAY'
    , DEL_YN        CHAR(1)
);
