...
CREATE TABLE MEMBER (
   NO              NUMBER           CONSTRAINT PK_MEMBER_NO   PRIMARY KEY 
    ...
    ,NICK          VARCHAR2(20)     CONSTRAINT NN_MEMBER_NI   NOT NULL UNIQUE
...
ALTER TABLE MEMO 
ADD CONSTRAINT FK_MEMO_CODE
FOREIGN KEY (CODE) REFERENCES MEMBER(CODE)
;
...
ALTER TABLE ACCOUNT_BOOK 
ADD CONSTRAINT FK_ACCOUNT_CODE
FOREIGN KEY (CODE) REFERENCES MEMBER(CODE)
;
...
CREATE TABLE QNA (
   NO                  NUMBER          CONSTRAINT PK_QNA_NO PRIMARY KEY
    ...
    , ADMIN_CONTENT     VARCHAR2(4000)  NOT NULL
    , ADMIN_ENROLL_DATE   TIMESTAMP       NOT NULL
);
...
ALTER TABLE ANNIVERSARY 
ADD CONSTRAINT FK_ANNIVERSARY_CODE
FOREIGN KEY (CODE) REFERENCES MEMBER (CODE)
;
